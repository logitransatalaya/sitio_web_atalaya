			...
			<div className={styled.SobreNosotros}>
				<div className={styled.initialTextContainer}>
					...
					<div>
						...
						<p>
							...
							Colombiana de Logística y Transporte, que cumple con
							todos los estándares de calidad en el servicio y
							confiabilidad, contamos con talento experto en
							logística, modelos de gestión en seguridad y
							control, distribución de mercadería a nivel nacional
							y urbano, manejo de contenedores (puertos Cartagena)
							y alianzas en transporte OTM.
						</p>
				...
				<div className={styled.SecondPartContainer}>
					...
					<div className={styled.CardContainer}>
						...
						<Card icon='developer' title='Tecnología de punta' />
					</div>
				</div>
